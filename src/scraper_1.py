...
"""
webscraper takes 2 urls to return regular season statistics
"""


def scrape_stats(url, url1):
    '''
    this function pulls statistics for the 2018 NFL regular season, it is built for 
    specific urls, it should return strings, floats, and ints, if notrun the helper functions
...
### run the following to pull the statistics for the 2018 season
...
df2018 = scrape_stats(url, url1)

#run the two following url's to scrape the 2019 stats
